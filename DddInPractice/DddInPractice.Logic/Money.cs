...
namespace DddInPractice.Logic
{
    ...
    public sealed class Money : ValueObject<Money>
    {
        ...
        public static readonly Money Cent = new Money(1, 1, 0, 0, 0, 0);
        public static readonly Money TenCent = new Money(0, 0, 1, 0, 0, 0);
        public static readonly Money QuarterCent = new Money(0, 0, 0, 0, 0, 0);
